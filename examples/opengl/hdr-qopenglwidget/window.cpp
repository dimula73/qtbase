...
Window::Window()
{
    ...
    m_imageWidget = new KisGLImageWidget(QColorSpace::SRgbLinear, this);
    ...
    m_imageWidgetSdr = new KisGLImageWidget(QColorSpace::SRgbLinear, this);
...
void Window::updateSurfaceInfo()
{
    ...
    m_lblContextInfo->setText(
        QString("renderer: %1\ncolorSpace: %2\n\n")
                ...
                .arg(format.colorSpace() == QColorSpace::SRgb ? "sRGB" :
                     format.colorSpace() == QColorSpace::SRgbLinear ? "scRGB" :
                     format.colorSpace() == QColorSpace::Bt2100Pq ? "Bt. 2020 PQ" :
                     "unknown"));
}
